...
class PerfilsControllerTest < ActionController::TestCase
  ...
  test "should create perfil" do
    assert_difference('Perfil.count') do
      post :create, perfil: { apellidoMaterno: @perfil.apellidoMaterno, apellidoPaterno: @perfil.apellidoPaterno, nombre: @perfil.nombre, usuario_id: @perfil.usuario_id }
    end
  ...
  test "should update perfil" do
    put :update, id: @perfil, perfil: { apellidoMaterno: @perfil.apellidoMaterno, apellidoPaterno: @perfil.apellidoPaterno, nombre: @perfil.nombre, usuario_id: @perfil.usuario_id }
    assert_redirected_to perfil_path(assigns(:perfil))
  end

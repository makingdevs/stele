...
databaseChangeLog = {
  ...
  changeSet(author: "makingdevs (generated)", id: "1410360948203-1") {
    ...
    sql("update payment set payment_type='WIRE_TRANSFER' where payment_type='TRANSFERENCIA_BANCARIA'")
    sql("upadte payment set payment_type='REFERENCED_DEPOSIT' where payment_type='FICHA_REFERENCIADA'") 
    sql("upadte payment set payment_type='CHECK' where payment_type='CHEQUE_FICHA'") 
    sql("upadte payment set payment_type='CASH' where payment_type='EFECTIVO'") 

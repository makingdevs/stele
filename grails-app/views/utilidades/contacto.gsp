...
<div class="container">     
    <div class="row margin-bottom-30">
        <div class="col-md-8 mb-margin-bottom-30">
            ...
            <p>Comunícate con nuestros expertos vía correo electrónico o vía telefónica para descubrir cómo podemos ayudar a su colegio para implementar un nuevo sistema de cobros. Te garantizamos la mejor solución para lograr el éxito en la administraión de tu colegio y la satisfacción de los padres de familia.
            </p><br />
            <form>
        ...
        <div class="col-md-4">
            ...
            <ul class="list-unstyled who margin-bottom-30">
                ...
                <li><a href="#"><i class="icon-envelope-alt"></i><a href="mailto:info@stele..mx" class="">info@stele.mx</a> </li>

...
<div class="row-fluid">
	<table id="tableCobrosGenerados" class="table table-striped table-bordered table-hover">
		<thead>
            <tr>
				<th>Nombre</th>
				<th>Ubicacion</th>
		...
		<tbody>
            <g:each in="${listaCobrosGenerados}" var="dependiente">
                <tr>
					<td>
...
jQuery(function($) {
    var oTable1 = $('#tableCobrosGenerados').dataTable( {
        bAutoWidth: false,
        "aoColumns": [null, null, null, {"bSortable": false}, {"bSortable": false}, null, {"bSortable": false}],
        "aaSorting": [],
           "language": {

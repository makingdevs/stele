...
<div class="row-fluid">
	<table id="tableCobrosPorConciliar"
		...
		<thead>
            <tr>
				...
				<th>Descuentos</th>
				<th>Recargo</th>
				<th>Adjunto </br> Comprobante</th>
				<th>Dias Sin </br> Conciliar</th>
			</tr>
		</thead>
		<tbody>
		    <g:each in="${listaCobrosPorCanciliar}" var="dependiente">
	            <tr>
...
<script type="text/javascript">
	jQuery(function($) {
		var oTable2 = $('#tableCobrosPorConciliar').dataTable( {
            bAutoWidth: false,
            "aoColumns": [
              null, null, null,{ "bSortable": false },
              { "bSortable": false },null,{ "bSortable": false },null,null                 
              ],
            "aaSorting": [],
               "language": {

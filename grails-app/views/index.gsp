    ...
    <div class="row margin-bottom-10">
        <div class="col-md-4 service-alternative">
            <div class="service">
                ...
                <div class="desc">
                    <h4>Tu información siempre contigo</h4>
                    <p>Para su colegio esto representa que todos los empleados y padres de familia, pueden acceder a su información en cualquier momento y desde cualquier lugar de forma segura.</p>
                </div>
            </div>  
        </div>
        <div class="col-md-4 service-alternative">
            <div class="service">
                ...
                <div class="desc">
                    <h4>Activar la productividad</h4>
                    <p>Su colegio podrá trabajar de una manera más rápida y eficaz al proporcionarle a sus empleados una forma sencilla de trabajar simplificando sus actividades y tareas.</p>
                </div>
            </div>  
        </div>
        <div class="col-md-4 service-alternative">
            <div class="service">
                ...
                <div class="desc">
                    <h4>Reduccion de costos</h4>
                    </br>
                    <p>Los sistemas en la nube permiten reducir los costos de tecnologia, no es necesario comprar o mantener servidores, personas especializadas en tecnología ni infraestrcutura adicional.</p>

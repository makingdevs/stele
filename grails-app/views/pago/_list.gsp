...
<table class="table">
  ...
  <tbody>
  <g:findAll in="${pagos?.pagosProcesados}" expr="it.estatusDePago == EstatusDePago.PROCESO  ">
      <tr class="info">
  ...
  <g:findAll in="${pagos.pagosRechazados}" expr="it.estatusDePago == EstatusDePago.RECHAZADO  ">
      <tr class="error">
        <td> ${it.conceptoDePago} </td>
        <td> $ ${it.cantidadDePago} </td>
        <td> <g:formatDate format="yyyy-MM-dd" date="${it.fechaDeVencimiento}"/> </td>
  ...
  <g:findAll in="${pagos.pagosPorRealizar}" expr="it.estatusDePago == EstatusDePago.CREADO  ">
      <tr>
        <td> ${it.conceptoDePago} </td>
        <td> $ ${it.cantidadDePago} </td>
        <td> <g:formatDate format="yyyy-MM-dd" date="${it.fechaDeVencimiento}"/> </td>
  ...
  <g:findAll in="${pagos.pagoCorrectos}" expr="it.estatusDePago == EstatusDePago.PAGADO  ">
      <tr class="success"> 
        <td> ${it.conceptoDePago} </td>
        <td> $ ${it.cantidadDePago} </td>
        <td> <g:formatDate format="yyyy-MM-dd" date="${it.fechaDeVencimiento}"/> </td>

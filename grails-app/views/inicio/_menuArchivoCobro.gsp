...
<div id="fuelux-wizard" class="row-fluid" data-target="#step-container">
	<ul class="wizard-steps">
		<li data-target="#step1" class="active" style="min-width: 16.666%; max-width: 16.666%;">
			<span class="step">1</span>
			<span class="title">Importe el archivo</span>
		</li>

		<li data-target="#step2" style="min-width: 16.666%; max-width: 16.666%;">
			<span class="step">2</span>
			<span class="title">Verifique</span>
		</li>

		<li data-target="#step3" style="min-width: 16.666%; max-width: 16.666%;">	
			<span class="step">3</span>
			<span class="title">Procesar Inscripción</span>
		</li>

		<li data-target="#step4" style="min-width: 16.666%; max-width: 16.666%;">

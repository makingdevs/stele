...
<div id="fuelux-wizard" class="row-fluid " data-target="#step-container">
  <ul class="wizard-steps">
    ...
    <li data-target="#step4" class="complete" style="min-width: 16.666%; max-width: 16.666%;">
      <span class="step">4</span>
      <span class="title">Resultado</span>
    </li>

    <li data-target="#step5" class="complete" style="min-width: 16.666%; max-width: 16.666%;">
      <span class="step">5</span>
      <span class="title">Cobro</span>
    </li>
    <li data-target="#step6" class="active" style="min-width: 16.666%; max-width: 16.666%;">
